                        ...
                        <li>
                            ...
                            @if (Auth::guard('talent')->check())
                                <a href="{{route('profile.index')}}">
                                    <i class="bi bi-person" style="font-size: 1.5rem !important;"></i>
                            ...
                            @elseif (Auth::guard('company')->check())
                                ...
                                <a href="{{route('company.profile.index')}}">
                                    <i class="bi bi-building" style="font-size: 1.5rem  !important;"></i>
                            ...
                            <li class="">
                                <a href="#"
                                   onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <i class="bi bi-box-arrow-right" style="font-size: 1.5rem  !important;"
                                    ></i> {{ trans('main.logout') }}
