@extends('front.layouts.master',['title'=>'Jobs Applies'])
            ...
            <div class="row g-4">
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="chatbot__developers text-center">
                        @include('front.pages.talent-dashboard.offers.jobs.partials.offers-list')
                    </div>
                </div>
            </div>
        </div>
        ...
        @push('js')
            <script>
                ...
                $(document).on('change', '.status', function () {
                    ...
                    setTimeout(function () {
                        $.ajax({
                            url: '{{ route('applyJobs.index') }}', // Adjust this URL to match your route
                            method: 'GET',
                            data: filters,
