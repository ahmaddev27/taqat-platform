...
@if(!auth()->guard('company')->check())
        ...
        <div
            ...
            <form id="sendProposal" class="row g-4"
                ...
                <div class="col-lg-6 basig__grpinput">
                    <label for="name" class="fz-20 fw-500 inter mb-16 title">Duration</label>
                    <input class="addquestion" type="number"
                           value="s" name="duration"
                           id="duration"
                           placeholder="Days">
                </div>
                ...
                <div class="col-lg-6 basig__grpinput">
                    <label for="email1s"
                           class="fz-20 fw-500 inter mb-16 title">Cost</label>
                    <input class="addquestion" name="cost" type="number"
                           value=""
                           id="email1s"
                           placeholder="$Cost">
                </div>
                ...
                <span class="fz-20 fw-500 inter title mb-16 d-block">
                    ...
                    <div>
                    <textarea id="bio" name="description" class="form-control round16" placeholder="Proposal Details"
                              rows="10"></textarea>
                    </div>
    ...
    @elseif($project->status!=1  && auth('talent')->user())
        ...
        <div class="review__commentbox mb-30">
            ...
            <div class="pt-24 bborderdash pb-24">
                ...
                <div class="d-flex pt-24 gap-3 align-items-center">
                    <img style="object-fit: cover;width: 80px;height: 80px" src="{{$myOffer[0]->user->photo}}"
...
@elseif(auth()->guard('company')->id()== $project->company_id)
        ...
        @foreach($project->offers as $offer)
            <div class="review__commentbox mb-30">
                ...
                <div class="pt-24 bborderdash pb-24">
                    ...
                    <div class="d-flex pt-24 gap-3 align-items-center">
                        <img style="object-fit: cover;width: 80px;height: 80px" src="{{$offer->user->photo}}"
                             class="round50" alt="re-img">
                        <div class="name__content">
                            <h5 class="title">
                                {{$offer->user->name}}
