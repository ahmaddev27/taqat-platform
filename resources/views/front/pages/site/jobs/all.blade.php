@extends('front.layouts.master',['title'=>'Jobs'])
            ...
            <div class="row g-4">
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="chatbot__developers text-center">
                        @include('front.pages.site.jobs.partials.jobs_list')
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('js')
        <script>
            ...
            $(document).on('change', '.filter__search input, .specializations, #customRangeMin, #customRangeMax', function () {
                ...
                setTimeout(function () {
                    $.ajax({
                        url: '{{route('jobs.all')}}', // Adjust this URL to match your route
                        method: 'GET',
                        data: filters,
