...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'whatsapp'              =>  'الواتساب'   ,
        'message'               =>  'الرسالة',
        'current_city'               =>  'المكان الحالي',
        'old_city'               =>  'المكان الاصلي',
        'job'               =>  'الوظيفة',
        'image'               =>  'الصورة',
        'skills'               =>  'المهارات',
        'know_some'               =>  'معرفة سابقة',
        'job_title'               =>  'التخصص',

        'title_en ' =>'العنوان بالانجليزي ',
        'title_ar ' =>'العنوان بالعربية',
        'active_theme'=>'الثيم الفعال',
        'duration'=>'مدة التسليم',
        'cost'=>'قيمة العرض',

        'photo'=>'الصورة',
        'original_place'=>'المكان الاصلي',

        'displacement_place'=>'الاقامة الحالية',
